...
export const dictionary: DictionaryEntry[] = [
  ...
  {
    message:
      '"入口" はAIが書いた文章で多用される比喩です。"最初の一歩" "とっかかり" などに言い換えられないか検討してください。',
    tokens: [noun("入口")],
  },
  {
    message:
      '"土台" はAIが書いた文章で多用される比喩です。"基礎" "前提" などに言い換えられないか検討してください。',
    tokens: [noun("土台")],
  },
  {
    message:
      '"道具" はAIが書いた文章で多用される比喩です。"ツール" "手段" などに言い換えられないか検討してください。',
    tokens: [noun("道具")],
  },
  {
    message:
      '"核心" はAIが書いた文章で多用される比喩です。"本質" "いちばん大事な点" などに言い換えられないか検討してください。',
    tokens: [noun("核心")],
  },
  {
    message:
      '"構図" はAIが書いた文章で多用される比喩です。"全体像" "関係" などに言い換えられないか検討してください。',
    tokens: [noun("構図")],
  },
  {
    message:
      '"線引き" はAIが書いた文章で多用される比喩です。"境界" "区別" などに言い換えられないか検討してください。',
    tokens: [noun("線引き")],
  },
  {
    message:
      '"事故" はAIが書いた文章で多用される比喩です。"障害" "不具合" などに言い換えられないか検討してください。',
    tokens: [noun("事故")],
  },
  {
    message:
  ...
  {
    message:
      '"落とし穴" はAIが書いた文章で多用される比喩です。"見落としやすい点" "つまずきやすい点" などに言い換えられないか検討してください。',
    tokens: [noun("落とし穴")],
  },
  {
    message:
  ...
  {
    message:
      '"素通り" はAIが書いた文章で多用される比喩です。"無視される" "処理されない" などに言い換えられないか検討してください。',
    tokens: [noun("素通り")],
  },
  {
    message:
      '"切り分ける" はAIが書いた文章で多用される比喩です。"原因を絞り込む" "分けて調べる" などに言い換えられないか検討してください。',
    tokens: [verb("切り分ける")],
  },
  {
    message:
      '"潰す" はAIが書いた文章で多用される比喩です。"直す" "解消する" などに言い換えられないか検討してください。',
    tokens: [verb("潰す")],
  },
  {
    message:
      '"踏み込む" はAIが書いた文章で多用される比喩です。"詳しく説明する" "立ち入る" などに言い換えられないか検討してください。',
    tokens: [verb("踏み込む")],
  },
  {
    message:
      '"溶かす" はAIが書いた文章で多用される比喩です。"境界をなくす" のように、何がどうなるかを書けないか検討してください。',
    tokens: [verb("溶かす")],
  },
  {
  ...
  {
    message:
      '"定石" はAIが書いた文章で多用される比喩です。"基本的な進め方" "よく使われる方法" などに言い換えられないか検討してください。',
    tokens: [noun("定石")],
  },
  {
  ...
  },
  {
    ...
    message:
      '"静かに" はAIが書いた文章で多用される比喩です。"エラーを出さずに" "気づかれないまま" などに言い換えられないか検討してください。',
    tokens: [
