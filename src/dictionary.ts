...
export const dictionary: DictionaryEntry[] = [
    {
        message: '"効く" は英語の直訳調です。"有効になる" "適用される" "効果がある" などに言い換えられないか検討してください。',
        tokens: [verb("効く")]
    },
    {
        message:
    ...
    },
    {
        ...
        message:
            '"〜に落ちる" をフォールバックの意味で使っていませんか。"〜が代わりに使われる" "既定の〜が使われる" などに言い換えられないか検討してください。',
        tokens: [ni, verb("落ちる")]
    },
    {
    ...
    {
        message: '"論外" は硬い表現です。"話にならない" "そもそも選べない" などに言い換えられないか検討してください。',
        tokens: [noun("論外")]
    },
    {
    ...
    {
        message: '"向き" は比喩です。"どちらがどちらを参照するか" のように、何がどうなっているかを書けないか検討してください。',
        tokens: [noun("向き")]
    },
    {
    ...
    {
        message: '"原料" は製造の語です。"もとになる値" "定義" などに言い換えられないか検討してください。',
