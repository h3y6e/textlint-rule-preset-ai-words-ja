...
export const dictionary: DictionaryEntry[] = [
    {
        message: '"効く" は英語の直訳調です。"適用される" "効果がある" などに言い換えられないか検討してください。',
        tokens: [verb("効く")]
    },
    {
        message:
            '"壊れる" は英語の直訳調です。"動かなくなる" "成り立たなくなる" "誤った結果になる" などに言い換えられないか検討してください。',
        tokens: [verb("壊れる")]
    },
    {
    ...
    {
        message:
            '"黙って" は英語の直訳調です。"気づかないまま" "警告を出さずに" "何も知らせずに" などに言い換えられないか検討してください。',
        tokens: [verb("黙る")]
    },
    {
    ...
    {
        message: '"崩す" は英語の直訳調です。"覆す" "成り立たなくする" などに言い換えられないか検討してください。',
        tokens: [verb("崩す")]
    },
    {
        // 「動かす」単独では「サーバを動かす」に当たるため、目的語の「値」を足す。
        message: '"値を動かす" は "値を変える" "値を変更する" に言い換えられないか検討してください。',
    ...
    {
        message: '"正本" は硬い表現です。"Single Source of Truth" "唯一の正しい情報源" "拠りどころ" などに言い換えられないか検討してください。',
        tokens: [noun("正本")]
    },
    {
        message: '"部品" は機械の語です。"パーツ" "コンポーネント" などに言い換えられないか検討してください。',
        tokens: [noun("部品")]
    },
    {
        message: '"検査" は硬い表現です。"チェック" "確かめる" などに言い換えられないか検討してください。',
        tokens: [noun("検査")]
    },
    {
        // kuromoji は「正典」を 正 + 典 に割る。
        message: '"正典" は硬い表現です。"Single Source of Truth" "唯一の正しい情報源" "拠りどころ" などに言い換えられないか検討してください。',
        tokens: [{ pos: "接頭詞", surface_form: "正" }, { pos: "名詞", surface_form: "典" }]
    },
    {
        // 名詞単独では「光配線方式」に当たるため、助詞とサ変動詞まで含めて比喩の用法だけを拾う。
        message: '"配線する" は英語の直訳調です。"つなぐ" "組み込む" などに言い換えられないか検討してください。',
    ...
    {
        message: '"原料" は製造の語です。"定義" に言い換えられないか検討してください。',
