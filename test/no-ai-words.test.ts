...
tester.run("no-ai-words", rule, {
    ...
    invalid: [
        ...
        invalid("いずれも動きません。", '"いずれも"'),
        invalid("これは設計の問題に他ならない。", '"〜に他ならない"'),
        invalid("これは設計の問題に他なりません。", '"〜に他ならない"'),
        invalid("これは設計の問題にほかならない。", '"〜にほかならない"'),
        invalid("これは設計の問題にほかなりません。", '"〜にほかならない"'),
        invalid("ファイルのみならずディレクトリも対象です。", '"〜のみならず"'),
        invalid("型が確定するという点で差があります。", '"〜という点で"'),
        invalid("限界を示すに過ぎません。", '"〜に過ぎない"'),
        invalid("限界を示すにすぎません。", '"〜に過ぎない"'),
